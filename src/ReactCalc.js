/*
 ...
 --harsha pulikollu
 https://github.com/harshapulikollu/React_Native_Calc
    ...
    return (
      <View style = {Style.rootContainer}>
        ...
        <View style = {Style.inputRow} key = {"row-" + 0}>
          <InputButton value={'C'} symbol={true} onPress={this._onInputButtonPressed.bind(this, 'c')} />
          <InputButton value={'Del'} symbol={true} onPress={this._onInputButtonPressed.bind(this, 'Del')} />
        </View>
          <View style = {Style.inputRow} key = {"row-" + 1}>
            ...
            <InputButton value={'+'} symbol={true} onPress={this._onInputButtonPressed.bind(this, '+')} />
          </View>
